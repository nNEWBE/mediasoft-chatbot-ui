      ...
      >
        ...
        <form onSubmit={handleRegister} className="space-y-4">
          <div className="space-y-2">
            ...
            <div className="relative group">
              <User className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-white/20 group-focus-within:text-brand-primary transition-colors z-10" />
              <Input
                type="text"
                required
        ...
        <div className="mt-8 text-center text-sm">
          <p className="text-white/30">
            ...
            <Link href="/login" className="text-brand-primary hover:underline transition-all font-semibold">Sign In Here</Link>
          </p>
        </div>
      </motion.div>
    </div>
